...
void vulkan_renderpass_create(vulkan_context* context, vulkan_renderpass* out_renderpass, f32 x, f32 y, f32 w, f32 h, f32 r, f32 g, f32 b, f32 a, f32 depth, u32 stencil)
{
    ...
    color_attachment.initialLayout = VK_IMAGE_LAYOUT_UNDEFINED; //Don't expect any particullar layout before render pass
    color_attachment.finalLayout = VK_IMAGE_LAYOUT_PRESENT_SRC_KHR; //Transicioned to after the render pass
    ...
    //TODO:Attachment(input, resolve, preserve)
    ...
    //Attachments not used in this subpass, but must be preserved for next one
